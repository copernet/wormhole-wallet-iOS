...
/*******************************************************************************
        ...
        WhDestroyAssetViewController.swift
        WHoleWallet
...
class WhDestroyAssetViewController: UIViewController, UITextFieldDelegate {
    ...
    func configView() {
        ...
        promptTag.text = "Will Destroy Token, And Cannot Revoke"
    ...
    @objc func sureAction()  {
        ...
        WhHTTPRequestHandler.unsignedOperate(reqCode: 56, parameters: parameters) { (result) in
            if result.count > 0 {
